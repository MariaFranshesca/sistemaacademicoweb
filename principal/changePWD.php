...
if(isset($_POST["old_Id"]) && isset($_POST["new_Id"])){
	...
	if($ck == $old){
		...
		$msg = "<div align='center'><font color='green'>Cambiado exitoso</font></div>";
		
	}
	else{
		//means some error occured
		$msg = "<div align='center'><font color='red'>Lo sentimos, la contraseña antigua no coincide. Intente de nuevo</font></div>";
	}
...
<html>
	...
	<body>
		<div class="container" align="center">
			...
			<caption align="center"><h3>Cambia la contraseña </h3></caption>
			<tbody>
